 ...
 * 
 */
@WebServiceClient(name = "BusinessService", targetNamespace = "http://webservice.rpc.gwang.com/client", wsdlLocation = "http://127.0.0.1:9527/BusinessService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BUSINESSSERVICE_QNAME = new QName("http://webservice.rpc.gwang.com/client", "BusinessService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:9527/BusinessService?wsdl");
    ...
    public Business getBusinessPort() {
        return super.getPort(new QName("http://webservice.rpc.gwang.com/client", "BusinessPort"), Business.class);
    }
    ...
    public Business getBusinessPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.rpc.gwang.com/client", "BusinessPort"), Business.class, features);
    }
